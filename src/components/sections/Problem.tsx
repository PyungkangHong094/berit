...
import { Clock, CloudFog, Battery } from "lucide-react";
        ...
        <section ref={containerRef} className="py-24 bg-white relative overflow-hidden">
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    <span className="text-primary font-medium tracking-wider uppercase text-sm">Why Berit?</span>
                ...
                <div ref={cardsRef} className="grid md:grid-cols-3 gap-8">
                    {problems.map((item, index) => (
                        <div
                            key={index}
                            className="problem-card p-8 rounded-2xl bg-background hover:shadow-lg transition-all duration-300 border border-gray-100"
                        >
